...
.top h2{
  margin:0; font-size:1.25rem; color:#222;
}
.back-btn{
  border:none; background:#50bdbd;
...
.label{
  font-weight:600; font-size:.9rem; color:#334;
}
.input{
  border-radius:12px;
